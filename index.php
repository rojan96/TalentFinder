    ...
    <div id="first">
           <div class="container">
                ...
                <nav class="navbar navbar-expand-sm">
                    <a class="navbar-brand" style="opacity: 1;" href="#"></a>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="signup.php"><h2>Sign up</h2></a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <div class="jumbotron">
                    ...
                    <p class="display-4">Tinder, but for Talent!</p>

                    <hr class="my-2">

                    <p class="lead">
                        <a class="btn btn-secondary btn-lg" href="Jumbo action link" role="button">Find Talent Now!</a>
                    </p>
                </div>
        ...
        <div class="jumbotron" style="background-color: #FBEAEB ">
            ...
            <h5 style="color:gray; text-align: center;color:#F4A950"> <a href="https://www.instagram.com"> Instagram </a></h5>
