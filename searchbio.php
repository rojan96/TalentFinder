...
$search = mysqli_query($conn,"SELECT * FROM userinfo WHERE Bio LIKE '%$keyword%'");
        ...
        <div class="card" style="margin-bottom: 1%">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <img src="img/userprofile/<?php echo $row['image'];?>" width="200" height="200">
                    </div>
                    <div class="col-md-9">
                        <div class="card-title h3">Name: <?php echo $row['Firstname']." ".$row['Lastname'].'<br>'; ?></div>
                        <div class="h4">Username: <?php echo $row['Username'] . '<br>'; ?></div>
                        <div class="h4">Bio: <?php echo $row['Bio'] . '<br>'; ?></div>
                        <div class="h4">Email : <?php echo $row['Email'] . '<br>'; ?></div>
                    </div>
                </div>
            </div>
        </div>
